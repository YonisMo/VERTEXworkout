  ...
  return (
    <tr className="border-b border-slate-100 transition hover:bg-slate-50">
      <td className="px-4 py-5">
        <div className="flex items-center gap-3">
          <Link
            href={`/dashboard/store/products/${product.slug}`}
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#F2EA79] text-[#022859] transition hover:scale-105"
          ...
          <div>
            <Link
              href={`/dashboard/store/products/${product.slug}`}
              className="font-bold text-[#022859] transition hover:underline"
            >
              {product.name}
            </Link>

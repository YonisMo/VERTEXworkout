...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-72px)] items-center overflow-hidden bg-[#022859] py-20 text-white" dir="ltr">
      ...
      <Container className="relative z-10 flex flex-col items-center justify-center text-center">
        ...
        {/* Title */}
        <h1 className="mt-8 font-cairo text-5xl font-black leading-tight tracking-tight text-white md:text-7xl lg:text-8xl text-center">
          Train Smarter.. Live Stronger..
        </h1>

        {/* Subtitle */}
        <p className="mx-auto mt-8 max-w-3xl font-tajawal text-lg font-medium leading-relaxed text-[#BFB8BA] sm:text-xl lg:text-2xl text-center">

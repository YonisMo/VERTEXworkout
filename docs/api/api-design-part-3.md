...
// Response 200
{
  ...
  "data": {
    ...
    "relatedProducts": [
      { "id": "uuid", "slug": "resistance-band-set", "name": "..." }
    ]
  }
}
```
    ...
    "items": [
      {
        ...
        "productName": "VERTEX Power Bag 15kg",
        "quantity": 2,
        "unitPrice": 1200,
        "lineTotal": 2400
      }
...
```json
{
  ...
  "data": {
    ...
    "videoUrl": "https://...",
    "muscles": [
      { "name": "الصدر", "role": "primary" },
      { "name": "الترايسبس", "role": "secondary" }
    ],
...
_(الجزء 4 والأخير: File Upload API، Image Processing، Webhooks، Server Actions Strategy، Supabase Edge Functions، API Versioning، OpenAPI/Swagger، API Testing Strategy.)_

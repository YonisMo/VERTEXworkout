...
_(الجزء 2 التالي: Dashboards الموحَّدة، Alerting Policy وOn-Call، مستويات شدة الحوادث، Business Metrics Monitoring، Synthetic Monitoring، سياسة الاحتفاظ بالسجلات، وChecklist نهائي.)_

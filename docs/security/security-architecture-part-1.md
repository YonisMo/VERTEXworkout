...
export function ArticleBody({ html }: { html: string }) {
  const clean = DOMPurify.sanitize(html, {
    ALLOWED_TAGS: ["p", "strong", "em", "ul", "li", "a", "img", "h2", "h3"],
  });
...
_(الجزء 2 التالي: SQL Injection Prevention، RLS Policies بالتفصيل، File/Storage Security، API Security الموسّع، CORS، CSP، Security Headers، Secrets Management، Environment Variables Security.)_
